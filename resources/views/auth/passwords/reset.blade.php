    ...
    <div class="container">
        <div class="login-card">
            ...
            <div class="login-header">
                ...
                <p>Introduz a tua nova palavra-passe abaixo</p>
            </div>
            ...
            <div class="login-body">
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="campo-group">
                        <label for="password" class="login-label">Nova palavra-passe</label>
                        <input id="password"
                               type="password"
                        ...
                        @error('password')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                        <span class="hint-texto">Mínimo 8 caracteres.</span>
                    </div>

                    <div class="campo-group">
                        <label for="password-confirm" class="login-label">Confirmar palavra-passe</label>
                    ...
                    <button type="submit" class="btn-login">
                        <i class="fas fa-key"></i> Redefinir Palavra-passe
                    </button>

                    <a class="voltar-link" href="{{ route('login') }}">
