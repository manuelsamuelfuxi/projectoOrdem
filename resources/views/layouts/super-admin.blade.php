...
<head>
    ...
    <title>@yield("title", "Super Admin — ORDEPDITA")</title>
...
<div class="sidebar">
    ...
    <div class="sidebar-brand">
        <div class="brand-badge">
            ...
            <div>
                ...
                <div class="brand-sub">Super Administrador</div>
            </div>
        </div>
    </div>

    <div class="sidebar-section">Principal</div>
    <a class="nav-link-item {{ request()->routeIs('super-admin.dashboard') ? 'active' : '' }}"
    ...
    <a class="nav-link-item {{ request()->routeIs('super-admin.admins.*') ? 'active' : '' }}"
       href="{{ route('super-admin.admins.index') }}">
        <span class="nav-icon"><i class="fas fa-users"></i></span>
        Administradores
    </a>
    <a class="nav-link-item {{ request()->routeIs('super-admin.pedidos.*') ? 'active' : '' }}"
       href="{{ route('super-admin.pedidos.financeiramente-aprovados') }}">
    ...
    <a class="nav-link-item {{ request()->routeIs('super-admin.relatorios.*') ? 'active' : '' }}"
       href="{{ route('super-admin.relatorios.completos') }}">
...
<div class="main-content">
    ...
    <a href="{{ route('super-admin.perfil.editar') }}"
       style="display:flex; align-items:center; gap:8px; text-decoration:none; color:#334155;">
